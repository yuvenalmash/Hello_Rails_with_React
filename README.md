...
```sh
  cd my-folder
  git clone git@github.com:yuvenalmash/Hello_Rails_with_React.git
```
...
Feel free to check the [issues page](https://github.com/yuvenalmash/Hello_Rails_with_React/issues).
